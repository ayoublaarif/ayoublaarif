        ...
        <div class="container">
            <div class="fmc">
                ...
                <div class="biy-gallery">
                    ...
                    <img class="biy biy-7" src="@/assets/img/biy-7.jpg"/>
                    <img class="biy biy-8" src="@/assets/img/biy-8.jpg"/>
                </div>
            </div>
        </div>
    </div>
       ...
       //display: flex;
        ...
        .fmc{
            ...
            .fmc-title{
                ...
                z-index: 5;
                .title{
                @include ivymode(6.5rem,2.5rem,400);
